"""Unit probes for core.services.diagnostics (no network, no registry load needed)."""
from core.services.diagnostics import (capability_matrix, check_connectivity,
