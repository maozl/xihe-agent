...
core.support.interrupt register pair are monkeypatched so no real codex child
...
import core.services.external_agent as ea
import core.support.interrupt as iv
