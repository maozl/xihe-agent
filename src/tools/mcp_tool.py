...
# ``core.services.external_agent`` — see ``core.support.safe_env``. Imported + aliased here so
...
from core.support.safe_env import (
...
def _load_mcp_config() -> Dict[str, dict]:
    ...
    try:
        from core.services.store import store_installed_mcp
