...
version: 1.1.0
author: Xihe Agent (adapted from obra/superpowers)
license: MIT
metadata:
...
> **For Xihe:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use xihe tools to understand the project:
